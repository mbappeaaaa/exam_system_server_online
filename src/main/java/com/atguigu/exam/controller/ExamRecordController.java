...
public class ExamRecordController {
   ...
   private ExamService examService;
    ...
    public Result<Page<ExamRecord>> getExamRecords(
        ...
        Page<ExamRecord> pageData = new Page<>(page, size);
        examRecordService.pageExamRecords(pageData, studentName, status, startDate, endDate);
    ...
    public Result<ExamRecord> getExamRecordById(
        ...
        ExamRecord examRecord =examService.getExamRecord(id);
    ...
    public Result<Void> deleteExamRecord(
            @Parameter(description = "考试记录ID") @PathVariable Integer id) {
        examRecordService.removeRecord(id);
        log.info("删除考试记录：{}", id);

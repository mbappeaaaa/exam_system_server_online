...
public class BannerController {
    ...
    public Result<String> uploadBannerImage(
       ...
       String imageURL= bannerService.uploadfile(file);
       log.info("轮播图调用回显地址为{}",imageURL);
    ...
    public Result<List<Banner>> getActiveBanners() {
        ...
        //返回结果
        Result<List<Banner>> listResult = Result.success(bannerList);
        log.info("获取轮播图列表成功: {}", bannerList);
        return listResult;
    }
...
//        List<Banner> bannerList = bannerService.list();
    ...
    public Result<String> toggleBannerStatus(
        ...
        log.info("id={}的轮播图,接口调用修改成功,修改后的状态为{}", id, isActive);
        return Result.success(null);
    }
}
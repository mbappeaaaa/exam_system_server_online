...
public class PaperController {
    ...
    public Result<java.util.List<Paper>> listPapers(
        ...
        queryWrapper.eq(StringUtils.hasText(status), Paper::getStatus, status);
        List<Paper> paperList = paperService.list(queryWrapper);
        log.info("查询试卷列表，参数：name=" + name + ", status=" + status);
